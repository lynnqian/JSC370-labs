...
tab <- met[, .(N_entries = .N, N_entries_na = sum(is.na(temp_cat)),
...
ggplot(station_ave, aes(x = wind.sp_50, y = temp_50)) + 
  geom_point() + geom_smooth(method = "lm") + geom_smooth(method = "gam", col = 2)
...
-   https://github.com/lynnqian/JSC370-labs.git
